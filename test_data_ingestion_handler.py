...
def test_upload_file_arguments(mocker, handler, sample_data):
    ...
    expected_calls = [
        mocker.call(json.dumps({"orders_id": "123", "last_updated": "2024-02-25"}), "orders/123/2024-02-25"),
        mocker.call(json.dumps({"orders_id": "124", "last_updated": "2024-02-26"}), "orders/124/2024-02-26"),
    ]
