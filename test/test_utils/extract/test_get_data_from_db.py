...
from src.extract.extract_utils.get_data_from_db import ConnectionError
import unittest
...
class MockingTestTestCase(unittest.TestCase):
    ...
    def test_get_data_from_db_return_all_tables_as_expected(
        self, mock_cr_con
    ):
    ...
    @patch("src.extract.extract_utils.get_data_from_db.create_conn")
    def test_get_data_from_db_return_address_table_values_as_expected(
        self, mock_cr_con
    ):
        mock_connection_db = MagicMock()
        mock_cr_con.return_value = mock_connection_db
    ...
    @patch("src.extract.extract_utils.get_data_from_db.create_conn")
    def test_get_data_from_db_return_counterparty_table_values_as_expected(
        self, mock_cr_con
    ):
    ...
    @patch("src.extract.extract_utils.get_data_from_db.create_conn")
    def test_get_data_from_db_return_currency_table_values_as_expected(
        self, mock_cr_con
    ):
        mock_connection_db = MagicMock()
        mock_cr_con.return_value = mock_connection_db
    ...
    @patch("src.extract.extract_utils.get_data_from_db.create_conn")
    def test_get_data_from_db_return_department_table_values_as_expected(
        self, mock_cr_con
    ):
    ...
    @patch("src.extract.extract_utils.get_data_from_db.create_conn")
    def test_get_data_from_db_return_payment_table_values_as_expected(
        self, mock_cr_con
    ):
    ...
    @patch("src.extract.extract_utils.get_data_from_db.create_conn")
    def test_get_data_from_db_return_payment_type_table_values_as_expected(
        self, mock_cr_con
    ):
    ...
    @patch("src.extract.extract_utils.get_data_from_db.create_conn")
    def test_get_data_from_db_return_purchase_order_table_values_as_expected(
        self, mock_cr_con
    ):
    ...
    @patch("src.extract.extract_utils.get_data_from_db.create_conn")
    def test_get_data_from_db_return_sales_order_table_values_as_expected(
        self, mock_cr_con
    ):
    ...
    @patch("src.extract.extract_utils.get_data_from_db.create_conn")
    def test_get_data_from_db_return_transaction_table_values_as_expected(
        self, mock_cr_con
    ):
    ...
    @patch("src.extract.extract_utils.get_data_from_db.create_conn")
    def test_get_data_from_db_return_dict_and_nested_list(self, mock_cr_con):
